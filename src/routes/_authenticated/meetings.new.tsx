        ...
        <div className="mx-auto max-w-2xl rounded-xl border bg-card p-6 shadow-sm sm:p-8">
          ...
          {step === 1 && (
            <div className="space-y-6">
              <VotationEditor votations={votations} onChange={setVotations} />
              <div className="flex justify-between">
                <Button variant="outline" onClick={() => setStep(0)}>
                  Tilbake
                </Button>
                <Button onClick={() => setStep(2)}>Neste: Deltakere</Button>
              </div>
            </div>
          )}
          ...
          {step === 2 && (
            <div className="space-y-6">
              <ManageParticipants participants={participants} onChange={setParticipants} />
              <div className="flex justify-between">
